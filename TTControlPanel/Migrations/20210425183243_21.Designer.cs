...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TTGitServer.Models.AuthorizationLog", b =>
                {
                    b.Property<Guid>("ID")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("TTGitServer.Models.SshKey", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TTGitServer.Models.Team", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TTGitServer.Models.TeamRepositoryRole", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TTGitServer.Models.UserTeamRole", b =>
                {
                    b.Property<long>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("TTGitServer.Models.AuthorizationLog", b =>
                {
                    b.HasOne("TTControlPanel.Models.User", "User")
            ...
            modelBuilder.Entity("TTGitServer.Models.TeamRepositoryRole", b =>
                {
                    b.HasOne("TTGitServer.Models.Repository", "Repository")
                        .WithMany()
                        .HasForeignKey("RepositoryID");

                    b.HasOne("TTGitServer.Models.Team", "Team")
                        .WithMany()
